...
public class DataBank {
    ...
    private static HashMap<String, Building> buildingName = new HashMap<>(); // name to building
    ...
    public void initializeBuildingName() {
        ...
        buildingName.put("killing pit",new CastleBuilding(null,0,"killing pit",
                75, Resource.WOOD,6,0,new ArrayList<Texture>(List.of(Texture.GROUND)),
                null,0,0,0,null,null,50, null));
        buildingName.put("Inn",new OtherBuilding(null,100,"Inn",
                75, Resource.WOOD,20,1,new ArrayList<Texture>(List.of(Texture.GROUND)),
                null,2,0));
        buildingName.put("Mill",new OtherBuilding(null,0,"Mill",
                75, Resource.WOOD,20,3,new ArrayList<Texture>(List.of(Texture.GROUND)),
                null,2,0));
        buildingName.put("Iron mine",new OtherBuilding(null,0,"Iron mine",
                75, Resource.WOOD,20,2,new ArrayList<Texture>(List.of(Texture.GROUND)),
                null,2,0));
        buildingName.put("Market",new OtherBuilding(null,0,"Market",
                75, Resource.WOOD,5,1,new ArrayList<Texture>(List.of(Texture.GROUND)),
                null,0,0));
        ...
        buildingName.put("Stockpile",new OtherBuilding(null,0,"Stockpile",
                75, Resource.WOOD,0,0,new ArrayList<Texture>(List.of(Texture.GROUND)),
                null,0,100));
        buildingName.put("Woodcutter",new OtherBuilding(null,0,"Woodcutter",
                75, Resource.WOOD,1,0,new ArrayList<Texture>(List.of(Texture.GROUND)),
                null,2,0));
        buildingName.put("Hovel",new OtherBuilding(null,0,"Hovel",39, Resource.WOOD,
                6,0,new ArrayList<Texture>(List.of(Texture.GROUND)),null,null,8));
        buildingName.put("Church",new OtherBuilding(null,250,"Church",309,
                null,0,0,
                new ArrayList<Texture>(List.of(Texture.GROUND)),null,2,null));
        ...
        buildingName.put("Poleturner",new WeaponBuilding(null,100,"Poleturner",114,Resource.WOOD,
                10,1,new ArrayList<Texture>(List.of(Texture.GROUND)),
                null,new ArrayList<>(List.of(Resource.METAL)),10));
        ...
        buildingName.put("Hop garden",new OtherBuilding(null,0,"Hop garden",39, Resource.WOOD,
                15,1,new ArrayList<Texture>(List.of(Texture.GROUND)),
                null,2,null));
        buildingName.put("hunting post",new OtherBuilding(null,0,"hunting post",39, Resource.WOOD,
                5,1,new ArrayList<Texture>(List.of(Texture.GROUND)),
                null,2,null));
        buildingName.put("Wheat garden",new OtherBuilding(null,0,"Hovel",39, Resource.WOOD,
                15,1,new ArrayList<Texture>(List.of(Texture.GROUND)),
                null,2,null));
        ...
        buildingName.put("Food StockPile",new OtherBuilding(null,0,"Food StockPile",39, Resource.WOOD,
                5,0,new ArrayList<Texture>(List.of(Texture.GROUND)),
                null,null,100));
